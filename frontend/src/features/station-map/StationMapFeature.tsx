    ...
    <div className="relative h-full min-h-0 overflow-hidden bg-surface-container-low">
      ...
      <div className="pointer-events-none relative z-40 flex h-full min-h-0 flex-col justify-between lg:flex-row">
        ...
        <div className="relative min-h-0 flex-1 lg:order-1 lg:h-full lg:flex-1">
          <Card className="station-places-panel pointer-events-auto absolute bottom-0 left-0 top-auto flex h-[var(--map-panel-height)] w-full min-h-0 flex-col overflow-hidden rounded-t-2xl border-b-0 border-l-0 bg-surface/95 shadow-xl backdrop-blur-xl lg:top-0 lg:h-full lg:w-[var(--map-panel-width)] lg:rounded-none lg:border-y-0">
            <header className="station-places-header flex min-w-0 shrink-0 items-center gap-sm border-b border-outline-variant/70 bg-surface-bright/75 p-[var(--layout-gutter)]">
