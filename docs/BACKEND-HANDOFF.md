...
- 장소 단건 조회와 계정별 장소 즐겨찾기
- 좌표/지도 경계 기반 주변 장소 조회(현재 역 기준 최대 1km)
- 실제 도보 경로 비교(현재 직선거리 기반 로컬 추정)
- 후기 좋아요·신고
- 모집 질문 댓글·신고·연결 일정 공개 조회
- 일정 소프트 삭제·3일 복원과 공유 일정 복제
- 관리자 신고/감사 로그/동기화 작업 API
## 1. 핵심 원칙
